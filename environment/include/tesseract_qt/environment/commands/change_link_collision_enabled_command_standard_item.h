 ...
 */
#ifndef TESSERACT_QT_ENVIRONMENT_CHANGE_LINK_COLLISION_ENABLED_COMMAND_STANDARD_ITEM_H
#define TESSERACT_QT_ENVIRONMENT_CHANGE_LINK_COLLISION_ENABLED_COMMAND_STANDARD_ITEM_H
