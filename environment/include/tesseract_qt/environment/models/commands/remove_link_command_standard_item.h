...
{
public:
  explicit RemoveLinkCommandStandardItem(std::shared_ptr<const tesseract::environment::RemoveLinkCommand> command);
...
#endif  // TESSERACT_QT_ENVIRONMENT_REMOVE_LINK_COMMAND_STANDARD_ITEM_H
