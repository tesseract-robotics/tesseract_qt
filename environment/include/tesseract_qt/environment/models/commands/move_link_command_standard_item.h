...
{
public:
  explicit MoveLinkCommandStandardItem(std::shared_ptr<const tesseract::environment::MoveLinkCommand> command);
...
#endif  // TESSERACT_QT_ENVIRONMENT_MOVE_LINK_COMMAND_STANDARD_ITEM_H
