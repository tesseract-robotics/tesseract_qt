 ...
 */
#ifndef TESSERACT_QT_PLOT_TRANSFORMS_MOVING_AVERAGE_FILTER_H
#define TESSERACT_QT_PLOT_TRANSFORMS_MOVING_AVERAGE_FILTER_H
...
private:
  std::unique_ptr<Ui::MovingAverageFilter> ui;
