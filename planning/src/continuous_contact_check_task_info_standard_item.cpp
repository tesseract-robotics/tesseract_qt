...
{
ContinuousContactCheckTaskInfoStandardItem::ContinuousContactCheckTaskInfoStandardItem(
    const tesseract_planning::ContinuousContactCheckTaskInfo& info)
  : TaskComposerNodeInfoStandardItem(icons::getUnknownIcon(), "Continuous Contact Check Task Info", info)
{
  ctor(info);
}
...
int ContinuousContactCheckTaskInfoStandardItem::type() const
{
  return static_cast<int>(StandardItemType::MP_CONTINUOUS_CONTACT_CHECK_TASK_INFO);
}

void ContinuousContactCheckTaskInfoStandardItem::ctor(const tesseract_planning::ContinuousContactCheckTaskInfo& info)
{
