...
int main(int argc, char** argv)
{
  ...
  auto component_info = tesseract::gui::ComponentInfoManager::create("tesseract_scene");
  tesseract::gui::EnvironmentManager::set(
      std::make_shared<tesseract::gui::DefaultEnvironmentWrapper>(component_info, env));

  tesseract::gui::TaskComposerToolBar toolbar(component_info);
  tesseract::gui::TaskComposerWidget widget(component_info);
