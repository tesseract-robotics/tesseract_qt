 ...
 */
#ifndef TESSERACT_QT_SCENE_GRAPH_SCENE_STATE_WIDGET_H
#define TESSERACT_QT_SCENE_GRAPH_SCENE_STATE_WIDGET_H
...
class SceneStateWidget : public QWidget
{
  Q_OBJECT
...
public:
  ...
  std::shared_ptr<const SceneStateModel> getModel() const;
...
#endif  // TESSERACT_QT_SCENE_GRAPH_SCENE_STATE_WIDGET_H
