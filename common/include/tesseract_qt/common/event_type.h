...
enum class EventType : int
{
  ...
  // Scene Graph
  SCENE_GRAPH_SET                        = TOOL_PATH_TYPES_END + 1,
  SCENE_GRAPH_ADD_LINK                   = TOOL_PATH_TYPES_END + 2,
  SCENE_GRAPH_ADD_JOINT                  = TOOL_PATH_TYPES_END + 3,
  SCENE_GRAPH_MOVE_LINK                  = TOOL_PATH_TYPES_END + 4,
  SCENE_GRAPH_MOVE_JOINT                 = TOOL_PATH_TYPES_END + 5,
  SCENE_GRAPH_REMOVE_LINK                = TOOL_PATH_TYPES_END + 6,
  SCENE_GRAPH_REMOVE_JOINT               = TOOL_PATH_TYPES_END + 7,
  SCENE_GRAPH_REPLACE_JOINT              = TOOL_PATH_TYPES_END + 8,
  SCENE_GRAPH_MODIFY_LINK_VISIBILITY     = TOOL_PATH_TYPES_END + 9,
  SCENE_GRAPH_MODIFY_LINK_VISIBILITY_ALL = TOOL_PATH_TYPES_END + 10,
  ...
  ACM_VISIBILITY      = ACM_TYPES_START + 5,
  ACM_TYPES_END       = ACM_TYPES_START + 6,
