...
enum class EventType : int
{
  ...
  TOOL_PATH_HIDE_SELECTED   = RENDER_TYPES_END + 7,
  TOOL_PATH_SHOW            = RENDER_TYPES_END + 8,
  TOOL_PATH_SHOW_ALL        = RENDER_TYPES_END + 9,
  TOOL_PATH_SHOW_SELECTED   = RENDER_TYPES_END + 10,
