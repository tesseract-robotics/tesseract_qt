...
enum class StandardItemType : int
{
  ...
  ENV_COMMAND_ADD_ALLOWED_COLLISION                 = SG_TYPES_END + 11,
  ENV_COMMAND_REMOVE_ALLOWED_COLLISION              = SG_TYPES_END + 12,
  ENV_COMMAND_REMOVE_ALLOWED_COLLISION_LINK         = SG_TYPES_END + 13,
  ENV_COMMAND_ADD_SCENE_GRAPH                       = SG_TYPES_END + 14,
  ENV_COMMAND_CHANGE_JOINT_POSITION_LIMITS          = SG_TYPES_END + 15,
  ENV_COMMAND_CHANGE_JOINT_VELOCITY_LIMITS          = SG_TYPES_END + 16,
  ENV_COMMAND_CHANGE_JOINT_ACCELERATION_LIMITS      = SG_TYPES_END + 17,
  ENV_COMMAND_ADD_KINEMATICS_INFORMATION            = SG_TYPES_END + 18,
  ENV_COMMAND_REPLACE_JOINT                         = SG_TYPES_END + 19,
  ENV_COMMAND_CHANGE_COLLISION_MARGINS              = SG_TYPES_END + 20,
  ENV_COMMAND_ADD_CONTACT_MANAGERS_PLUGIN_INFO      = SG_TYPES_END + 21,
  ENV_COMMAND_SET_ACTIVE_DISCRETE_CONTACT_MANAGER   = SG_TYPES_END + 22,
  ENV_COMMAND_SET_ACTIVE_CONTINUOUS_CONTACT_MANAGER = SG_TYPES_END + 23,
