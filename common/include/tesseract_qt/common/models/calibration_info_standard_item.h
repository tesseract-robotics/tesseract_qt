...
{
public:
  CalibrationInfoStandardItem(tesseract::common::CalibrationInfo calibration_info);
  explicit CalibrationInfoStandardItem(const QString& text, tesseract::common::CalibrationInfo calibration_info);
...
#endif  // TESSERACT_QT_COMMON_CALIBRATION_INFO_STANDARD_ITEM_H
