...
{
public:
  explicit VectorStringStandardItem(const std::vector<std::string>& vector_string);
  VectorStringStandardItem(const QString& text, const std::vector<std::string>& vector_string);
  VectorStringStandardItem(const QIcon& icon, const QString& text, const std::vector<std::string>& vector_string);
