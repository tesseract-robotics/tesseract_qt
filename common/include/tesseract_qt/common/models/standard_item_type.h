...
enum class StandardItemType : int
{
  ...
  SG_SIGNED_DISTANCE_FIELD = JOINT_TRAJECTORY_SET_END + 25,
  SG_VISUALS       = JOINT_TRAJECTORY_SET_END + 26,
  SG_COLLISIONS    = JOINT_TRAJECTORY_SET_END + 27,
  SG_SCENE_STATE   = JOINT_TRAJECTORY_SET_END + 28,
  SG_TYPES_END     = JOINT_TRAJECTORY_SET_END + 29,
  ...
  // Environment Type
  ENVIRONMENT           = ENV_COMMAND_TYPES_END + 1,
  ENVIRONMENT_TYPES_END = ENV_COMMAND_TYPES_END + 2,

  // Collision Types
  COLLISION_CONTACT_RESULT            = ENVIRONMENT_TYPES_END + 1,
  COLLISION_CONTACT_RESULT_VECTOR     = ENVIRONMENT_TYPES_END + 2,
  COLLISION_CONTACT_RESULT_MAP        = ENVIRONMENT_TYPES_END + 3,
  COLLISION_CONTACT_RESULT_MAP_VECTOR = ENVIRONMENT_TYPES_END + 4,
  COLLISION_CONTACT_REQUEST           = ENVIRONMENT_TYPES_END + 5,
  COLLISION_CONTACT_DETAILS           = ENVIRONMENT_TYPES_END + 6,
  COLLISION_COLLISION_MARGIN_DATA     = ENVIRONMENT_TYPES_END + 7,
  COLLISION_TYPES_END                 = ENVIRONMENT_TYPES_END + 8,
  ...
  CL_SET_DIGITAL_INSTRUCTION = COLLISION_TYPES_END + 7,
  CL_SET_TOOL_INSTRUCTION    = COLLISION_TYPES_END + 8,
  CL_TIMER_INSTRUCTION       = COLLISION_TYPES_END + 9,
  CL_WAIT_INSTRUCTION        = COLLISION_TYPES_END + 10,
  CL_COMPOSITE_INSTRUCTION   = COLLISION_TYPES_END + 11,
  CL_VECTOR_INSTRUCTION      = COLLISION_TYPES_END + 12,
  CL_NULL_INSTRUCTION        = COLLISION_TYPES_END + 13,
  CL_INSTRUCTION             = COLLISION_TYPES_END + 14,
  CL_PLAN_INSTRUCTION        = COLLISION_TYPES_END + 15,
  CL_TYPES_END               = COLLISION_TYPES_END + 16,

  // Motion planning types
  MP_PLANNING_PROFILE_REMAPPING         = CL_TYPES_END + 1,
  MP_PROCESS_PLANNING_REQUEST           = CL_TYPES_END + 2,
  MP_TASK_COMPOSER_PORT_MAP             = CL_TYPES_END + 3,
