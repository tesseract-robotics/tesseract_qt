...
enum class StandardItemType : int
{
  ...
  MP_CONTINUOUS_CONTACT_CHECK_TASK_INFO = CL_TYPES_END + 8,
  MP_DISCRETE_CONTACT_CHECK_TASK_INFO   = CL_TYPES_END + 9,
  MP_FIX_STATE_COLLISION_TASK_INFO      = CL_TYPES_END + 10,
  MP_MOTION_PLANNING_TASK_INFO          = CL_TYPES_END + 11,
  MP_TOTG_TAKS_INFO                     = CL_TYPES_END + 12,
  MP_TYPES_END                          = CL_TYPES_END + 13,
