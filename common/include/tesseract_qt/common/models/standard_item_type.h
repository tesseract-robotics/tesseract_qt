...
enum class StandardItemType : int
{
  ...
  COLLISION_CONTACT_REQUEST       = ENVIRONMENT_TYPES_END + 3,
  COLLISION_CONTACT_DETAILS       = ENVIRONMENT_TYPES_END + 4,
  COLLISION_COLLISION_MARGIN_DATA = ENVIRONMENT_TYPES_END + 5,
  COLLISION_TYPES_END             = ENVIRONMENT_TYPES_END + 6,
