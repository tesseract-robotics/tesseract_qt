...
std::shared_ptr<ComponentInfo> ComponentInfoModel::getComponentInfo(const boost::uuids::uuid& ns) const
{
...
void ComponentInfoModel::add(std::shared_ptr<ComponentInfo> component_info)
{
