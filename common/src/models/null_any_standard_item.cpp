...
NullAnyStandardItem::NullAnyStandardItem(const QString& text) : QStandardItem(icons::getUnknownIcon(), text) {}

NullAnyStandardItem::NullAnyStandardItem(const QIcon& icon, const QString& text) : QStandardItem(icon, text) {}
